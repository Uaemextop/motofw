...
class ExtraInfo:
    ...
    brand: str = "motorola"
    model: str = "moto g05"
    fingerprint: str = "motorola/lamul_g/lamul:15/VVTA35.51-28-15/bd4d30:user/release-keys"
    radio_version: str = ""
    build_tags: str = "release-keys"
    build_type: str = "user"
    build_device: str = "lamul"
    build_id: str = "VVTA35.51-28-15"
    build_display_id: str = "VVTA35.51-28-15"
    build_incremental_version: str = ""
    release_version: str = "15"
    ota_source_sha1: str = "23d670d5d06f351"
    network: str = "wifi"
